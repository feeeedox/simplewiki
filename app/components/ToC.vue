...
<template>
    <div class="sm:ml-4 sm:mt-4 sm:my-0 pt-2 px-3.5 pb-2.5 bg-toc-bg border border-border rounded-xs text-[0.8125rem] [counter-reset:toc-main] sticky top-4 my-8 "
